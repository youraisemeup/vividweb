...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#calculationForm').on('submit', function(event){
            ...
            window.location.href= "<?php echo e(URL('/failed-valve')); ?>";
		})
...
<div class="center-wrapper">
	...
	<div class="replace-form">
	 <?php echo Form::open(['url' => '/metric-calculation','method'=>'POST', 'id'=>'calculationForm']); ?>

	<div class="vivid-tabs vividtab2 calType <?php //if(@$data['ResCode'] != 100){ echo "calType"; } ?>">
		<ul class="nav">
			<li class="<?php echo e(@$data['Data']['measurement_type'] == 'METRIC' ? 'active' : (!isset($data['Data']) ? 'active' : '' )); ?> "><a data-toggle="tab" id="home" href="#home">METRIC</a></li>
			<li class="<?php echo e(@$data['Data']['measurement_type'] == 'IMPERIAL' ? 'active' :  ''); ?> "><a data-toggle="tab" id="menu1" href="#menu1">IMPERIAL</a></li>
		</ul>
	</div>
	<div class="weighing">
		<?php  //print_r(@$data);
		...
		<div class="row custom-res">
			<div class="col-6">
				<div class="form-group pull-left">
					<label for="height">HEIGHT (<?php echo e($heightunit); ?>)</label>
					<input type="text" id="input_height" style="color: #21308b;" name="input_height" class="form-control focusClass"   value="<?php echo e(@$data['Data']['input_height']); ?>" <?php if(@$data['ResCode'] == 100){ echo "readonly"; } ?> >
				</div>
			</div>
			<div class="col-6">
		...
		<div class="row custom-res">
			<div class="col-6">
				<div class="form-group  pull-left">
					...
					<input type="text" id="cal_bsa" class="form-control" placeholder="??" value="<?php echo e(@$data['bsa']); ?>" readonly>
				</div>
			</div>
			<div class="col-6">
				<div class="form-group pull-right">
					<label for="bmi">BMI (kg/m<sup>2</sup>)</label>
					<input type="text" id="cal_bmi" class="form-control" placeholder="??" value="<?php echo e(@$data['bmi']); ?>" readonly>

						<?php echo e(Form::hidden('pagetype','new', array('id'=>'pagetype', 'style'=>'display:none;'))); ?>
	...
	<?php //} ?>
	<?php echo e(Form::text('measurement_type','METRIC', array( 'style'=>'display:none;', 'id' => 'measurement_type'))); ?>

	<?php //if(@$data['ResCode'] != 100){  ?>
	<!-- <?php echo e(Form::submit('NEXT', array('class'=>'btn btn-vivid btn-block next disable', 'style'=>'position:relative; margin-top:15px','id'=>'calculatBtn' ,'disabled'=>true) )); ?> -->
	<?php //}else{ ?>
	<div class="custom-re-button" style="width:100%">
		<?php echo e(Form::submit('NEXT', array('class'=>'btn btn-vivid btn-block next', 'style'=>'position:relative;margin-top:15px','id'=>'calculatBtn' ) )); ?>

	</div>
	<?php //} ?>
	<!-- <a class="btn btn-vivid btn-block next" style="position: relative;" href="<?php echo e(url('f-valve-info')); ?>">NEXT </a> -->
	 <?php echo Form::close(); ?>
