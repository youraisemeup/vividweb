...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$('#failedValveForm').on('submit', function(event){
            ...
            window.location.href= "<?php echo e(URL('/transcatheter-valve')); ?>";
            /*$("#ddlValveType").attr("disabled", false);
		    $("#MechanismFailure").attr("disabled", false);
		    $("#ddlLableSize").attr("disabled", false); */
		})
...
<div class="center-wrapper customWR">
    ...
    <?php echo Form::open(['method'=>'post','url'=>'failed-valve','id'=>'failedValveForm']); ?>
    ...
    <div class="thv">
        ...
        (
    	 ...
    	 ?>
    	<?php echo e(Form::select('valveType', $valveType, '0', $ddl)); ?>
    ...
    <div class="thv">
    	...
    	<select name="lableSize" id="ddlLableSize" class="select-vivid form-control" <?php if($d){ echo "disabled" ;}?> >
            <option value=" <?php echo e($s); ?>"><?php echo e($sname); ?> </option>
        </select>
    </div>
    ...
    <div class="thv">
        ...
        <select name="fmechanism" id="MechanismFailure" class="select-vivid form-control" <?php if($d){ echo "disabled" ;}?> >
            <option value="<?php echo e($mname); ?>"><?php echo e($mname); ?> </option>
        </select>
    </div>
    ...
    <div class="vivid-tabs weighing weighing2 ProjectedEOA" style="margin-bottom:20px;display: none">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="eoa" placeholder="??" value="<?php echo e(@$valvedata['valvedata']['ProjectedEOA']); ?>" readonly>
        </div>
    </div>
    <div class="vivid-tabs weighing weighing2 weighing3 ieoa <?php echo e(@$valvedata['ResCode'] == 101 || @$valvedata['ResCode'] == 103 ?'weighing4':''); ?> <?php echo e(@$valvedata['ResCode'] == 101?'weighing5':''); ?>" style="display: none">
        <div class="form-group">
            <label for="email">INDEXED EOA (cm<sup>2</sup>/m<sup>2</sup>)</label>
            <?php //print_r($valvedata['ResCode']);?>
            <input type="text" class="form-control" id="ieoa" placeholder="??" value="<?php echo e(@$valvedata['ieoa']); ?>" readonly>
        </div>
    </div>
    <div class="vivid-tabs weighing weighing2">
        <div class="form-group">
            <label class="color-error" for="email" style="color:#000"><?php echo e(@$valvedata['Msg1']); ?></label>
        </div>
            <?php echo @$valvedata['Msg2']; ?>
    </div>
    <?php echo e(Form::submit('NEXT', array('id'=>'failedValveSubmit', "class"=>"btn btn-vivid btn-block next disable customWW", 'style'=>'width:100%;bottom:0;margin-bottom:15px;','disabled'=>true))); ?>
