...
<html lang="en">
   <head>
      ...
      <link href="<?php echo e(asset('admin/css/dataTables.bootstrap4.min.css')); ?>" rel="stylesheet" type="text/css">
                     ...
                     <div class="datatable mt-5">
                        ...
                        <table id="example" class="display nowrap table table-bordered" style="width:100%">
                           ...
                           <tbody id="data">
                              ...
                              <tr>
                                 <td><input type="checkbox" class="checkbox" id="<?php echo e($data->id); ?>" name="id[]" ></td>
                                 <td><?php echo e($data->Date); ?></td>
                                 <td><?php echo e($data->time); ?></td>
                                 <td><?php echo e($data->email); ?></td>
                                 <td><?php echo e($data->height); ?></td>
                                 <td><?php echo e($data->weight); ?></td>
                                 <td><?php echo e($data->failedValueType); ?></td>
                                 <td><?php echo e($data->lableSize); ?></td>
                                 <td><?php echo e($data->failureMechanism); ?></td>
                                 <td><?php echo e($data->thvType); ?></td>
                                 <td><?php echo e($data->userIP); ?></td>
                              </tr>
