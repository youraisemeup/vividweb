...
<html class="st-layout ls-top-navbar ls-bottom-footer show-sidebar sidebar-l1 sidebar-r1-xs" lang="en">
    ...
    <body class="need_height" style="overflow-y: hidden;position:fixed;width:100%">
        <div class="wrapper home" id="pagewrap" >
                ...
                <div class="container-fluid">
                    ...
                    <div class="center-wrapper text-center">
                        ...
                        <div class="button-start">
                            <a id="clear" class="btn btn-vivid btn-block pageload-link" href="<?php echo e(url('/metric-calculation')); ?>" style="background-image: radial-gradient(circle at 50% 50%, #96b4e7, #223183);opacity: 1 !Important; position: relative; text-transform: uppercase;text-align: -webkit-center;">Start </a>
                        </div>
                        <div class="privacyhome">
                            <p class="privacy">By clicking start, I confirm that I have read and agree to IVR <br><a href="<?php echo e(asset('data/VIVID Website - Privacy Policy - Final.pdf')); ?>">Privacy Policy</a> and  <a href="<?php echo e(asset('data/VIVID Website - Terms of Use - Final.pdf')); ?>"> Terms of Use</a></p>
                        </div>
                    </div>
                </div>
         ...
         <script src="<?php echo e(url('load-effect/js/classie.js')); ?>"></script>
         <script src="<?php echo e(url('load-effect/js/svgLoader.js')); ?>"></script>
         <script>
            (function() {
              localStorage.clear();
