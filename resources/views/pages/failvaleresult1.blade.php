            ...
            <div class="wrapper ev4">
                <div class="container-fluid">
                    ...
                    <div class="center-wrapper">
                        ...
                        <?php } if($data['ieoa']==0) { ?>
                        <?php } else { ?>
                        <div class="vivid-tabs weighing weighing2 weighing3 weighing4">
                            <div class="form-group">
                                <label for="email">INDEXED EOA AREA (cm^2/m^2)</label>
                                <input type="text" class="form-control" placeholder="??" value="{{ $data['ieoa'] }}">
                            </div>
                        </div>
                        <?php } ?>
                        <div class="vivid-tabs weighing weighing2">
                            <div class="form-group">
                                <label class="color-error" for="email">Severe Prosthetic-Patient Mismatch.</label>
                            </div>
                            <h3 class="black-text" style='color:red'>
