          ...
          @include('includes.navbar')
            <div class="center-wrapper">
               ...
               <div class="vivid-tabs vividtab2">
                  <ul class="nav">
                     <li class="active"><a data-toggle="tab" href="#home">METRIC</a></li>
                     <li><a data-toggle="tab" href="#menu1">IMPERIAL</a></li>
                  </ul>
               </div>
               ...
               <a class="btn btn-vivid btn-block next gray-type" style="position: relative;" href="{{url('/metric-calculation')}}">NEXT </a>
            </div>
