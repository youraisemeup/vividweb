            ...
            <div class="center-wrapper">
               <div class="vivid-tabs">
                  <ul class="nav nav-tabs">
                     <li id="first" class="active"><a data-toggle="tab" href="{{url('/matric-result')}}">PATIENT <br>BODY SIZE</a></li>
                     <li id="second"><a data-toggle="tab" href="{{url('/f-valve-calc')}}">FAILD <br>VALVE</a></li>
                     <li id="third" style="margin-right: 0;"><a data-toggle="tab" href="{{url('/t-valve-result')}}">TRANSCATHETER <br>VALVE</a></li>
                  </ul>
              </div>
                <div class="clearfix"></div>
               <div class="vivid-tabs vividtab2">
                  <ul class="nav">
                     <li class="active"><a data-toggle="tab" id="home" href="#home">METRIC</a></li>
                     <li><a data-toggle="tab" id="menu1" href="#menu1">IMPERIAL</a></li>
                  </ul>
               </div>
...
<script src="load-effect/js/classie.js"></script>
  ...
  //function to change tab imperial to metric change the data of height and width
    document.getElementById("stype").value = "METRIC";
    //$("#type").val("METRIC");
      ...
      $("#two").on('click',function(){
        $("#one").removeClass("active");
          $(this).addClass("active");
            $("#ht").text("HEIGHT (in)");
            $("#wt").text("WEIGHT (lb)");
            document.getElementById("stype").value = "IMPERIAL";
      });
    })
   </script>
</html>