         ...
         <div class="container-fluid">
            ...
            <div class="center-wrapper">
               <div class="vivid-tabs">
                ...
                <div class="thv">
                  <select name="valveType" id="" class="select-vivid form-control"  href="javascript:;">
...
<option value="{{ $data['mechanism']}}">{{ $data['mechanism']}}</option>         
             ...
             <!-- <div class="thv">
              <a class="btn btn-thv btn-block" href="javascript:;">{{ $valvedata[0]['failed_type'] }}<i class="fa fa-chevron-down pull-right" aria-hidden="true"></i> </a>
               </div>
                  <div class="thv">
               <a class="btn btn-thv btn-block" href="javascript:;">{{ $valvedata[0]['lable_size']}}<i class="fa fa-chevron-down pull-right" aria-hidden="true"></i> </a>
               </div>
                  <div class="thv">
               <a class="btn btn-thv btn-block" href="javascript:;">{{ $data['mechanism']}} <i class="fa fa-chevron-down pull-right" aria-hidden="true"></i> </a>
               </div>-->
                <div class="vivid-tabs weighing weighing2">
                  <div class="row custom">
                     <div class="col-md-4">
                       ...
                       <div class="col-md-4">
                        <div class="form-group">
                             <label for="height">VALVE HEIGH (mm)</label>
              ...
              <?php } else { ?>               
               <div class="vivid-tabs weighing weighing2">
                   <div class="form-group">
                       <label for="email">EFFECTIVE ORIFICE AREA (cm^2)</label>
                       <input type="text" class="form-control" placeholder="??" value="{{ $valvedata[0]['ProjectedEOA'] }}" readonly>
                    </div>
               </div>
            <?php } if($data['ieoa']==0) { ?>
            <?php } else { ?>               
                <div class="vivid-tabs weighing weighing2 weighing3 weighing4 weighing5">
                  <div class="form-group">
                     <label for="email">INDEXED EOA AREA (cm^2)</label>
              ...
              <?php } ?>
                <div class="vivid-tabs weighing weighing2">
                   <div class="form-group">
                           <label class="color-error" for="email">NO/MILD Prosthetic-Patient Mismatch.</label>
                        </div>
