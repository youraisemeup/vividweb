		...
		$("#thvType").change(function(){
			...
			if($(this).val() != '')
			{
				...
				$.ajax({
					url:"postFormdata",
	                type:"post",
    	            data:{_token: '{{ csrf_token() }}',ht:height,wt:weight,fvalveType:fvalveType,fvalveSize:fvalveSize,failureMechanism:failureMechanism,thvType:thvType},
...
<div class="replace-form">
	...
	{!! Form::open(['method'=>'post', 'id'=>'thvForm']) !!}
